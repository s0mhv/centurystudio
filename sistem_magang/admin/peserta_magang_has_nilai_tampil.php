...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        if ($permissions['delete'] == 1) {
            echo "<td><a href='index.php?page=peserta_magang_has_nilai_proses&id_has_nilai=" . $row['id_has_nilai'] . "' onclick='return confirm(\"Yakin ingin menghapus data ini?\")'>HAPUS</a></td>";
        }
