...
// Cek apakah ada parameter id_kehadiran dari GET request
if (isset($_GET['id_kehadiran'])) {
    // Mengambil data berdasarkan id_kehadiran yang dikirimkan
    $id_kehadiran = mysqli_real_escape_string($koneksi, $_GET['id_kehadiran']);
    $kehadiran_ambil = mysqli_query($koneksi, "SELECT * FROM kehadiran WHERE id_kehadiran='$id_kehadiran'");
    $kehadiran_edit = mysqli_fetch_array($kehadiran_ambil);
}
?>

<div class="form-container">
    <form action="kehadiran_proses.php" method="post">
        <?php if (isset($_GET['id_kehadiran'])) : ?>
            <input type="hidden" name="status" value="edit">
            <input type="hidden" name="id_kehadiran" value="<?php echo htmlspecialchars($kehadiran_edit['id_kehadiran']); ?>">
        <?php else : ?>
        ...
        <table>
            <tr>
                <td colspan="3" align="center">
                    <h3><?php echo isset($_GET['id_kehadiran']) ? 'EDIT DATA KEHADIRAN' : 'TAMBAH DATA KEHADIRAN'; ?></h3>
                </td>
            </tr>
            <tr>
            <td>Nama</td>
            ...
            <tr>
                <td colspan="3" align="center">
                    ...
                    <input type="button" value="BATAL" onclick="window.location.href='index.php?page=kehadiran_tampil';">
                </td>
            </tr>
        </table>
    </form>
