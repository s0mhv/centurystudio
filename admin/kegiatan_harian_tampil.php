...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        if ($permissions['delete'] == 1) {
            echo "<td><a href='#' onclick=\"if (confirm('Apakah anda yakin data dihapus ?')) {window.location.href='kegiatan_harian_proses.php?status=hapus&id_kegiatan_harian=$row[id_kegiatan_harian]';}\">HAPUS</a></td>";
        }
