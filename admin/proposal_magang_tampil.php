...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        if ($permissions['delete'] == 1) {
            echo "<td><a href='' onclick=\"if (confirm('Apakah anda yakin data dihapus ?')) {window.location.href='proposal_magang_proses.php?status=hapus&id_proposal=$row[id_proposal]';}\">HAPUS</a></td>";
        }
