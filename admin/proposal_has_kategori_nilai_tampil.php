...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        if ($permissions['delete'] == 1) {
            echo "<td><a href='#' onclick=\"if (confirm('Apakah anda yakin data dihapus ?')) {window.location.href='proposal_has_kategori_nilai_proses.php?status=hapus&id_proposal_has_kategori_nilai=$row[id_proposal_has_kategori_nilai]';}\">HAPUS</a></td>";
        }
